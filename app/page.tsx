...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col justify-between">
      ...
      <footer style={{ padding: '40px 20px', textAlign: 'center', fontSize: '13px', color: '#666', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <a href="/privacy" style={{ margin: '0 15px', color: '#CCFF00', textDecoration: 'none' }} className="hover:underline">Privacy Policy</a> | 
        <a href="/contact" style={{ margin: '0 15px', color: '#CCFF00', textDecoration: 'none' }} className="hover:underline">Contact Us</a>
        <p style={{ marginTop: '15px', color: '#444' }}>© 2026 Review Sniper AI. All Rights Reserved.</p>
      </footer>
    </div>
  );
}